      ...
      <div className={`w-full h-full relative bg-orange-5 rounded-md p-4`}>
        <div className="">
          <div className="flex gap-8">
            ...
            <div className="">
              ...
              <ul className="text-xs text-latte flex flex-col gap-2">
                <li className="description-lime-clamp-2">{description}</li>
                <li className="description-lime-clamp-3">{method}</li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="border border-orange text-orange rounded-md px-2 py-1">
              Copy
            </button>
          </div>
        </div>
